...
<template>
  ...
  <h1 style="font-weight: bolder; text-align: center; margin-bottom: 50px; margin-top: 3rem">{{$t('header.smallbox.rentals')}}</h1>
  <div class="flex align-items-center justify-content-center gap-6 flex-wrap">
    <div class="flex flex-column gap-3 w-3 align-items-center">
      ...
      <h2>{{$t('booking.time.time')}}:  {{$t('general.minutes')}}</h2>
      <h2>{{$t('general.price')}}: S/.</h2>
